"""
   Program to preprocess datasets and prepare weight embedding vectors from word2vec, dependency and fatcual embeddings
   @author: Chinnappa Guggilla, NLP Researcher, TU Darmsatdt, AUg. 2016
"""
