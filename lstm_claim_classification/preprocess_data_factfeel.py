"""
Preprocessing code for generating weight vectors from individual word embeddings  for given dataset on fact-feel dataset
Some of the Code is borrowed from http://deeplearning.net/tutorial/lstm.html#lstm
@author: Chinnappa Guggilla, NLP, ML Researcher, TU Darmstadt, Aug. 2016
